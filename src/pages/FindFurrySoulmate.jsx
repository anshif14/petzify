...
const FindFurrySoulmate = () => {
  ...
  // Add this new function to fetch the seller's contact details
  ...
  const handlePetClick = async (pet) => {
    ...
    // Fetch seller details if they exist
    if (pet.userId) {
      const sellerDetails = await fetchSellerDetails(pet.userId);
      if (sellerDetails) {
        // Merge seller details with pet object
        setSelectedPet(prev => ({
          ...prev,
          sellerDetails
        }));
                      ...
                      <div>
                        ...
                        <div className="grid grid-cols-2 gap-4 mb-6">
                          <div className="flex">
                            ...
                            <span className="text-gray-700">{selectedPet.age || 'Not specified'}</span>
                          </div>
                          <div className="flex">
                            <span className="font-semibold w-24 text-gray-900">Gender</span>
                            <span className="text-gray-700">{selectedPet.gender || 'Not specified'}</span>
                          </div>
                        ...
                        {/* Seller contact information - only show after clicking Welcome Me Home */}
                        {selectedPet.sellerDetails && (
                          <div className="mb-6 p-4 bg-blue-50 rounded-lg border border-blue-100">
                            <h3 className="text-md font-semibold text-gray-900 mb-2">Seller Contact Information</h3>
                            {selectedPet.sellerDetails.phone && (
                              <div className="flex items-center mb-2">
                                ...
                                <span className="text-gray-800">{selectedPet.sellerDetails.phone}</span>
                              </div>
                            )}
                            {selectedPet.sellerDetails.phone && (
                              <a 
                                href={`https://wa.me/${selectedPet.sellerDetails.phone.replace(/[^0-9]/g, '')}`}
                                target="_blank"
                                rel="noopener noreferrer"
                                className="mt-2 flex items-center justify-center w-full px-4 py-2 bg-green-500 text-white rounded-md hover:bg-green-600 transition-colors"
                              >
                        ...
                        <button
                          ...
                          className="mt-6 w-full px-6 py-3 bg-gray-500 text-white rounded-lg hover:bg-gray-600 transition duration-200 flex items-center justify-center"
                        >

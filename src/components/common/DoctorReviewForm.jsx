...
const DoctorReviewForm = ({ 
  ...
  const uploadImage = async () => {
    ...
    try {
      ...
      const storageRef = ref(storage, `doctorReviews/${appointmentId}/${selectedImage.name}`);
  ...
  return (
    <div className="bg-white rounded-md p-4">
      <h3 className="text-lg font-medium text-gray-800 mb-3">
        Review your appointment with Dr. {doctorName}
      </h3>
      ...
      <form onSubmit={handleSubmit}>
        ...
        <div className="flex justify-between items-center mt-5">
          <p className="text-xs text-gray-500">
            Your review will help other pet owners choose the right veterinarian
          </p>
          <button
            type="submit"

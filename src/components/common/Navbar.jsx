...
const Navbar = () => {
  ...
  return (
    <>
      {/* Desktop Navbar */}
      <nav className={`fixed top-0 w-full z-50 transition-all duration-300 ${isScrolled ? 'bg-white/95 shadow-md' : 'bg-white/80'} hidden md:block`}>
      ...
      <nav className={`fixed top-0 w-full z-50 transition-all duration-300 ${isScrolled ? 'bg-white/95 shadow-md' : 'bg-white/80'} md:hidden`}>
        <div className="container mx-auto px-4 py-3">
          <div className="flex justify-between items-center">
            {/* Logo */}
            <div className="flex flex-col">
              <Link to="/home" className="flex items-center">
                <img src={logoText} alt="Petzify" className="h-6 w-auto" />
              </Link>
              <div className="mt-1 ml-1 scale-90 origin-left">
                <LocationDisplay />
              </div>
            </div>
      ...
      {isMobileMenuOpen && (
        <div className="fixed top-[60px] left-0 right-0 z-40 md:hidden bg-white shadow-lg">
